...
defined('IN_MOBIQUO') or defined('TT_WEB_PUSH') or exit;
if(!class_exists('xmlrpcval'))
{
...
function mobiquo_get_user_icon2($userid)
{
    require_once(dirname(dirname(dirname(__FILE__)))."/includes/functions_user.php");
    ...
    $userAvatar = fetch_avatar_url($userid);
    
    $useravatar[$userid] = $userAvatar[0] ? get_icon_real_url($userAvatar[0]) : '';

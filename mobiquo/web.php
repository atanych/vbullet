...
function print_screen($current_plugin_version)
{
	...
	$check_upload_status = !(boolean)(fileperms(CWD1 . '/upload.php')<755);
	$check_push_status   = !(boolean)(fileperms(CWD1 . '/push.php')<755);
...
{
	$tp_lst_pgurl = 'http://api.tapatalk.com/v.php?sys=vb40&link';

...
switch ($request_method)
{
    ...
    case 'register':
         ...
         $_POST['password_md5'] = md5($request_params[1]);
    ...
    case 'get_participated_topic':
        ...
        $_GET['pagenumber'] = $page;
        $_GET['perpage'] = $limit;
        $_GET['st'] = $request_params[1];
        $_GET['end'] = $request_params[2] == 'ERROR_NON_NUMERIC_FOUND' ? 19 : $request_params[2];
    ...
    case 'm_move_topic':
        ...
        $_POST['do'] = 'domovethreads';
				if (!isset($request_params[2]) or $request_params[2] === TRUE) {
    ...
    case 'get_user_info': $mobi_wol_path = 'member.php'; break;

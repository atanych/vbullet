...
define('FILE_VERSION', '3.8.1'); // this should match install.php
define('SIMPLE_VERSION', '381'); // see vB_Datastore::check_options()
define('YUI_VERSION', '2.6.0'); // define the YUI version we bundle, used for external YUI

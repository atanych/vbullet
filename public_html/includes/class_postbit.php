...
*
* @package 		vBulletin
* @version		$Revision: 28735 $
* @date 		$Date: 2008-12-09 05:36:58 -0600 (Tue, 09 Dec 2008) $
*
*/
	...
	function process_attachments()
	{
		...
		if (is_array($this->post['attachments']))
		{
			...
			foreach ($this->post['attachments'] AS $attachmentid => $attachment)
			{
				...
				else if (!($forumperms & $this->registry->bf_ugp_forumpermissions['canseethumbnails']))
				{
					$attachment['hasthumbnail'] = 0;
				}

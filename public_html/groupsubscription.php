...
if ($_REQUEST['do'] == 'viewsubscription')
{
	...
	// Construct navbits
	$navbits = array('usercp.php' . $vbulletin->session->vars['sessionurl_q'] => $vbphrase['user_control_panel'], '' => $vbphrase['subscribed_discussions']);
...
{
	$emailipdate = ($_POST['do'] == 'noemail') ? 0 : 1;

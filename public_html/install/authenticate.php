...
if (strlen('43bb78a9737c4066a05cb14d1e7482e3') == 32)
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', '43bb78a9737c4066a05cb14d1e7482e3');
}
else
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', md5(strtoupper('43bb78a9737c4066a05cb14d1e7482e3')));
}
